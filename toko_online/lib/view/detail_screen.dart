            ...
            Container(
                child: Center(
                    child: Container(
                        ...
                        child: Text(itemList[itemIndex].discount.toString()+"%")
                    )
                )
            ),
            Image.asset(itemList[itemIndex].photoAsset, fit: BoxFit.fitWidth),
            Padding(
              ...
              child: Row(
                children: <Widget>[
                  ...
                  Padding(
                    ...
                    child: Text("("+itemList[itemIndex].rating.toString()+")"),
                  )
                ],
              ),
            ),
...
class RadioForm extends StatefulWidget{
  ...
  State<StatefulWidget> createState() {
    return _FormState(itemList[index].color[0], itemList[index].price);
  }
}
    ...
    return Column(
      children: [
        CustomRadioButton(
          ...
          buttonLables: ["US 6", "US 7", "US 8", "US 9"],
          buttonValues: ["US 6", "US 7", "US 8", "US 9"],
              ...
              Container(
                ...
                child: ListView.builder(
                  itemBuilder: (BuildContext context, int index){
                    final List<Color> color = itemList[widget.index].color;
                    return InkWell(
                  ...
                  itemCount: itemList[widget.index].color.length,
            ...
            children: [
              ...
              IconButton(icon:Icon(Icons.keyboard_arrow_up) , onPressed: (){
                setState(() {
                  if(_qty<=9){
                    _qty++;
                    _total+=itemList[widget.index].price;
                  }
                });
              ...
              children: <Widget>[
                ...
                ElevatedButton(
                  ...
                  onPressed: (){
                    cartList.add(
                        CartItem(
                            name: itemList[widget.index].name,
                            total: itemList[widget.index].price * _qty,
                            imageAsset: itemList[widget.index].photoAsset,
                            size: _size,
                            color: _color,
