...
Widget sneakerTab(List<ProductItem> datalist){
    ...
    return Padding(
      ...
      child: GridView.builder(
          ...
          itemBuilder: (BuildContext context, index){
            if(datalist[index].type == "Sneakers") {
              return InkWell(
                onTap: (){
                  Navigator.push(context, MaterialPageRoute(
                    builder: (context) => DetailScreen(object: datalist[index])
                  ));
                },
                child: Container(
                  decoration: BoxDecoration(
      ...
      onPressed: () {
        setState(() {
          if(_iconColor == Colors.red){
            _iconColor = Colors.black26;
            itemList[index].isLiked = false;
          }else{
            _iconColor = Colors.red;
            itemList[index].isLiked = true;
          }
        });
      },
    );
